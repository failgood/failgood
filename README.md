...
### Boring
Failgood is boring at runtime. Every test runs with fresh dependencies, just like in junit 4, see [test lifecycle](docs/how%20to%20write%20tests%20with%20failgood.md). For advanced lifecyle option look at [More on lifecycle](docs/isolation.md)
