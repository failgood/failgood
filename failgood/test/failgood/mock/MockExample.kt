        ...
        testsAbout("new mock syntax") {
            it("looks like this") {
                ...
                the(userManager) {
                    ...
                    method { functionWithParameters(anyInt(), anyString()) }
                        .returns("resultString1")
                    method { functionWithDataClassParameters(any()) }.returns("resultString2")
                    method { functionThatReturnsNullableString() }
                        .will { throw RuntimeException("oops I failed") }
                }
                ...
                // this way you can assert on call order, or ignore certain parameter values. also
                // you can
